# -*- coding: utf-8 -*-
"""
Created on Thu Sep  9 09:38:32 2021

@author: Greyson Ramirez Pd.5
"""
...
cv2.createTrackbar("color5R", 'Orange Parts of Image', 255, 255, lambda x:None)
cv2.createTrackbar("color5B", 'Orange Parts of Image',0, 255, lambda x:None)
...
while (keypressed != 27 and keypressed != ord('s')):
    ...
    #Colors for "papers"
    red_paper[0:image_height,0:image_width, 0:image_channels] = [cv2.getTrackbarPos("color1B", 'Red Parts of Image'), cv2.getTrackbarPos("color1G", 'Red Parts of Image'), cv2.getTrackbarPos("color1R", 'Red Parts of Image')]
    yellow_paper[0:image_height,0:image_width, 0:image_channels] = [cv2.getTrackbarPos("color2B", 'Yellow Parts of Image'),cv2.getTrackbarPos("color2G", 'Yellow Parts of Image'),cv2.getTrackbarPos("color2R", 'Yellow Parts of Image')]
    green_paper[0:image_height,0:image_width, 0:image_channels] = [cv2.getTrackbarPos("color3B", 'Green Parts of Image'),cv2.getTrackbarPos("color3G", 'Green Parts of Image'),cv2.getTrackbarPos("color3R", 'Green Parts of Image')]
    blue_paper[0:image_height,0:image_width, 0:image_channels] = [cv2.getTrackbarPos("color4B", 'Blue Parts of Image'),cv2.getTrackbarPos("color4G", 'Blue Parts of Image'),cv2.getTrackbarPos("color4R", 'Blue Parts of Image')]
    orange_paper[0:image_height,0:image_width, 0:image_channels] = [cv2.getTrackbarPos("color5B", 'Orange Parts of Image'),cv2.getTrackbarPos("color5G", 'Orange Parts of Image'),cv2.getTrackbarPos("color5R", 'Orange Parts of Image')]
    pink_paper[0:image_height,0:image_width, 0:image_channels] = [cv2.getTrackbarPos("color6B", 'Pink Parts of Image'),cv2.getTrackbarPos("color6G", 'Pink Parts of Image'),cv2.getTrackbarPos("color6R", 'Pink Parts of Image',)]
    
    #THIS SETS THE POINT WHERE IT DIVIDES LIGHT AND DARK
    grayscale_break1 = newTrackbarPos('redYellow', 'Customized Image', 5)
