# -*- coding: utf-8 -*-
"""
Created on Thu Sep  9 15:35:56 2021
...
cv2.createTrackbar('Grayscale', 'Sliders', 42, 255, lambda x:None)
cv2.createTrackbar('Grayscale_2', 'Sliders', 84, 255, lambda x:None)
cv2.createTrackbar('Grayscale_3', 'Sliders', 126, 255, lambda x:None)
cv2.createTrackbar('Grayscale_4', 'Sliders', 168, 255, lambda x:None)
cv2.createTrackbar('Grayscale_5', 'Sliders', 210, 255, lambda x:None)
cv2.createTrackbar('Grayscale_6', 'Sliders', 255, 255, lambda x:None)
...
while(keypressed != 27 and keypressed != ord('s')):
    grayscale_break = trackPosition('Grayscale', 'Sliders', 0, 42)
    grayscale_break_2 = trackPosition('Grayscale_2', 'Sliders', 43, 84)
    grayscale_break_3 = trackPosition('Grayscale_3', 'Sliders', 85, 126)
    grayscale_break_4 = trackPosition('Grayscale_4', 'Sliders', 127, 168)
    grayscale_break_5 = trackPosition('Grayscale_5', 'Sliders', 169, 210)
    grayscale_break_6 = trackPosition('Grayscale_6', 'Sliders', 211, 255)
    
    
    green_paper[0:image_height,0:image_width, 0:image_channels] = [cv2.getTrackbarPos('Color_1_B', 'Color Bars'),cv2.getTrackbarPos('Color_1_G', 'Color Bars'),cv2.getTrackbarPos('Color_1_R', 'Color Bars')]
    blue_paper[0:image_height,0:image_width, 0:image_channels] = [cv2.getTrackbarPos('Color_2_B', 'Color Bars'),cv2.getTrackbarPos('Color_2_G', 'Color Bars'),cv2.getTrackbarPos('Color_2_R', 'Color Bars')]
    red_paper[0:image_height,0:image_width, 0:image_channels] = [cv2.getTrackbarPos('Color_3_B', 'Color Bars'),cv2.getTrackbarPos('Color_3_G', 'Color Bars'),cv2.getTrackbarPos('Color_3_R', 'Color Bars')]
    yellow_paper[0:image_height,0:image_width, 0:image_channels] = [cv2.getTrackbarPos('Color_4_B', 'Color Bars'),cv2.getTrackbarPos('Color_4_G', 'Color Bars'),cv2.getTrackbarPos('Color_4_R', 'Color Bars')]
    ...
    print(min_grayscale_for_orange, max_grayscale_for_orange)
