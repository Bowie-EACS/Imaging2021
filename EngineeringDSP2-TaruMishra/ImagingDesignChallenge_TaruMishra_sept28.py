...
color4_paper[0:image_height,0:image_width, 0:image_channels] = [100,100,100]
color5_paper[0:image_height,0:image_width, 0:image_channels] = [100, 0, 150]
color6_paper[0:image_height,0:image_width, 0:image_channels] = [88, 0, 250]

#grayscale_break = 100
cv2.createTrackbar('Grayscale','Sliders2',50,150, lambda x:None) 
cv2.createTrackbar('Grayscale 2','Sliders2',60, 175, lambda x:None)
cv2.createTrackbar('Grayscale 3','Sliders2',100, 190, lambda x:None)
cv2.createTrackbar('Grayscale 4','Sliders2',110, 200, lambda x:None)
cv2.createTrackbar('Grayscale 5','Sliders2',115, 220, lambda x:None)
cv2.createTrackbar('Grayscale 6','Sliders2',116, 255, lambda x:None)
...
while(keypressed != 27 and keypressed != ord('s')):
    ...
    grayscale_break2 = trackPosition('Grayscale 2','Sliders2', 50)
    grayscale_break3 = trackPosition('Grayscale 3','Sliders2',60)
    grayscale_break4 = trackPosition('Grayscale 4', 'Sliders2', 70)
    grayscale_break5 =trackPosition('Grayscale 5', 'Sliders2', 100)
    grayscale_break6 =trackPosition('Grayscale 5', 'Sliders2', 125)    
